    ...
    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
        ...
        <form method="POST" action=" " enctype="multipart/form-data">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" value="{{$author->name}}" name="name" class="form-control form-control-sm"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="password" value="{{$author->password}}"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="email" value="{{$author->email}}" class="form-control form-control-sm"
                           id="colFormLabelSm" placeholder="col-form-label-sm">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="file" name="avatar" value="{{$author->avatar}}" class="form-control form-control-sm"
                           id="colFormLabelSm" placeholder="col-form-label-sm">
                </div>
            </div>
