    ...
    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
        ...
        <form method="POST" action=" ">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" value="{{$post->name}}" name="name" class="form-control form-control-sm"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" value="{{$post->text}}" name="text" class="form-control form-control-sm"
                           id="colFormLabelSm" placeholder="col-form-label-sm">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" value="{{$post->author_id}}" name="author_id"
